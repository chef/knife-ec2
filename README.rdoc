...
Creates a new security group with a given name and description.

== knife ec2 security group delete

Deletes a new security group with a given security group ID.

== knife ec2 security group list

Outputs a list of all security groups in the currently configured AWS account.

== knife ec2 security group rule add

Creates a new rule within a specified security group.

== knife ec2 security group rule delete

Deletes a rule from a specified security group.
