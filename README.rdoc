...
In order to communicate with the Amazon's EC2 API you will have to tell Knife about your AWS Access Key and Secret Access Key.  There are a number of ways to do this. The easiest way is to create some entries in your <tt>knife.rb</tt> file:
