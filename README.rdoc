...
Use <tt>-b / --bake AMI_IMAGE_NAME</tt> when using an ebs backed Amazon Machine Image to have knife snapshot the instance after the chef run.  It will label the newly created image with your argument to <tt>-b / --bake</tt>.

<b>Note:</b> Image names must be unique.
