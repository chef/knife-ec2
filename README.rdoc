...
If the installation fails on Ubuntu, you may need to do the following:
    sudo apt-get install build-essential libxml2 libxml2-dev libxslt-dev libyaml-dev zlib1g zlib1g-dev openssl libssl-dev
    
If you are using the Opscode omnibus installer, run:
